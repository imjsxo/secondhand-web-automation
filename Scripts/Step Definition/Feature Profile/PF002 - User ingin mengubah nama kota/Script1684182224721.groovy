...
WebUI.selectOptionByValue(findTestObject('Object Repository/Feature Profile/profile_select_city'), 'Kediri', true)
...
WebUI.click(findTestObject('Object Repository/Feature Profile/btn_nav_list'))

WebUI.verifyTextPresent('Kediri', false)
