...
WebUI.setText(findTestObject('Feature Login/login_input_email'), 'alt.nm-2yimtbe@yopmail.com')

WebUI.setText(findTestObject('Feature Login/login_input_password'), 'dsddd')

WebUI.click(findTestObject('Feature Login/login_button'))

WebUI.verifyTextPresent('Silahkan cek email anda untuk melakukan verifikasi terlebih dahulu', false)
