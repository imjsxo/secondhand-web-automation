...
WebUI.setText(findTestObject('Feature Login/login_input_email'), 'irmapujiandrianis@gmail.com')
...
WebUI.click(findTestObject('Feature Logout/button_logout'))

WebUI.verifyElementPresent(findTestObject('Feature Login/btn_nav_login'), 0)
