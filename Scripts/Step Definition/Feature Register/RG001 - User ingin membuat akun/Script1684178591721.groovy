...
WebUI.setText(findTestObject('Feature Register/register_input_email'), 'alt.xa-3oal6i55@yopmail.com')

WebUI.setText(findTestObject('Feature Login/login_input_password'), 'asdf123')
