...
WebUI.click(findTestObject('Feature Transaksi Penjual/ap_btn_diterima'))

WebUI.verifyElementPresent(findTestObject('Feature Transaksi Penjual/ap_alert_accept_success'), 2)
