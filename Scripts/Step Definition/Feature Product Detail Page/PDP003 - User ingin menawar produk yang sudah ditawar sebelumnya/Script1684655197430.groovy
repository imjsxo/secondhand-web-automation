...
WebUI.verifyElementNotPresent(findTestObject('Feature Product Detail Page/pdp_button_nego'), 0)

WebUI.verifyElementPresent(findTestObject('Feature Product Detail Page/pdp_button_wait_response'), 
    0)
